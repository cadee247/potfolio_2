...
function display_all() {
    ...
    myTable += "<th style='width: 100px; color: red; text-align: right;'>Remove</th>"; // Added Remove button header
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        myTable += "<td><button onclick='remove_selection(" + i + ")'>Remove</button></td>"; // Added Remove button
    }
